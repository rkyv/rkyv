...
use crate::{
    ...
    primitive::{
        ArchivedF32, ArchivedF64, ArchivedI128, ArchivedI16, ArchivedI32, ArchivedI64, ArchivedNonZeroI128, ArchivedNonZeroI16, ArchivedNonZeroI32, ArchivedNonZeroI64, ArchivedNonZeroU128, ArchivedNonZeroU16, ArchivedNonZeroU32, ArchivedNonZeroU64, ArchivedU128, ArchivedU16, ArchivedU32, ArchivedU64
    },
...
mod tests {
    ...
    fn with_struct() {
        ...
        #[rkyv(crate, derive(Debug))]
        struct Middle {
            #[rkyv(with = NicheInto<Zero>, niche = NaN, niche)] // Default = Bool
            a: Option<Nichable>,
