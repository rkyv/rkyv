...
/// use rkyv::out_field;
///
/// // The macro works on repr(Rust) structs as well, but for the purposes of
/// // asserting an exact guaranteed position of each field in this example,
/// // we'll use repr(C)
/// #[repr(C)]
/// struct Example {
///     a: i32,
...
/// // guaranteed by repr(C) layout, repr(Rust) has free reign
/// assert_eq!(a_pos, 0);
/// unsafe {
///     a_out.write(42);
/// }
