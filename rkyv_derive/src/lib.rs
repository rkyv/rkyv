...
/// as well. Adding the attribute `#[recursive]` to a field will suppress this trait bound and allow
/// recursive structures. This may be too coarse for some types, in which case `Archive` will have
...
///
/// This macro also supports the `#[archive]` and `#[recursive]` attributes. See [`Archive`] for
/// more information.
